...
export interface IIndex<I extends OpaqueIndex = OpaqueIndex> {
    ...
    calculateResultScores<D extends OpaqueDocumentStore, AggValue = Result[]>(context: SearchContext<I, D, AggValue>, index: I, prop: string, term: string, ids: string[]): SyncOrAsyncValue<TokenScore[]>;
    search<D extends OpaqueDocumentStore, AggValue = Result[]>(context: SearchContext<I, D, AggValue>, index: I, prop: string, term: string): SyncOrAsyncValue<TokenScore[]>;
    searchByWhereClause<D extends OpaqueDocumentStore, AggValue = Result[]>(context: SearchContext<I, D, AggValue>, index: I, filters: Record<string, boolean | string | string[] | ComparisonOperator>): SyncOrAsyncValue<string[]>;
